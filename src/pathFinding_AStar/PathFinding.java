...
public class PathFinding {
	...
	public void findPath(ArrayList<Integer> waypointListX, ArrayList<Integer> waypointListY, ArrayList<Integer> waypointDirection, boolean emptyLists,ArrayList<Integer> waypointShortListX,ArrayList<Integer> waypointShortListY){
		...
		if(traceList.equals(null)||traceList.size()==0){
			...
			waypointShortListX.add(traceList.get(0).getX());
			waypointShortListY.add(traceList.get(0).getY());
			...
			for(int i=1;i<traceList.size()-1;i++){
				...
				if(getXYAngle(dx, dy)!=iTurn){
					waypointShortListX.add(traceList.get(i).getX());
					waypointShortListY.add(traceList.get(i).getY());
				}
			...
			waypointShortListX.add(traceList.get(traceList.size()-1).getX());
			waypointShortListY.add(traceList.get(traceList.size()-1).getY());
	...
	private void loadFieldLayout(){
		...
		setRectObstacle(242-RobotXRadius-RobotSafetyLength, 664-RobotYRadius-RobotSafetyLength, 580+RobotXRadius+RobotSafetyLength, 982+RobotYRadius+RobotSafetyLength);//far side
